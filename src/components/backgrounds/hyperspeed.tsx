...
export const hyperspeedPresets = {
  ...
  three: {
    ...
    movingAwaySpeed: [10, 25],
    movingCloserSpeed: [-75, -115],
  ...
  four: {
    ...
    colors: {
      ...
      shoulderLines: 0x131318,
      brokenLines: 0x131318,
      leftCars: [0xffd9b3, 0xffcfa0, 0xffc488], // Pale orange
      rightCars: [0x555555, 0x666666, 0x777777], // Greyish
      sticks: 0xa4e3e6
    }
  },
  five: {
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, activePreset }) => {
  const mergedOptions: HyperspeedOptions = {
    ...defaultOptions,
    ...(activePreset ? (hyperspeedPresets[activePreset] as any) : {}),
    ...effectOptions
  };

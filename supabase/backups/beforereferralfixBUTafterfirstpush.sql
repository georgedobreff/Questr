...
CREATE OR REPLACE FUNCTION "public"."apply_internal_referral_rewards"("p_user_id" "uuid") RETURNS TABLE("referrer_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."apply_internal_referral_rewards"("p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."calculate_age_from_dob"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_age_from_dob"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_referral_code"("code_input" "text") RETURNS TABLE("valid" boolean, "referrer_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."validate_referral_code"("code_input" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "last_adventure_at" timestamp with time zone,
    "streak_freezes_available" integer DEFAULT 0,
    "referral_code" "text",
    "referred_by" "uuid",
    "referral_rewards_claimed" boolean DEFAULT false
);
...
CREATE INDEX "fcm_tokens_token_idx" ON "public"."fcm_tokens" USING "btree" ("token");
...
CREATE OR REPLACE TRIGGER "on_profile_dob_update" BEFORE INSERT OR UPDATE OF "date_of_birth" ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_age_from_dob"();
...
GRANT ALL ON FUNCTION "public"."apply_internal_referral_rewards"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."apply_internal_referral_rewards"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."apply_internal_referral_rewards"("p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."calculate_age_from_dob"() TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_age_from_dob"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_age_from_dob"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_referral_code"("code_input" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."validate_referral_code"("code_input" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_referral_code"("code_input" "text") TO "service_role";

-- Rename 'QuestSmith' achievement to 'Questr'
UPDATE public.achievements 
SET 
    code = 'Questr', 
    title = 'Questr', 
    icon_name = 'Questr' 
WHERE code = 'questsmith';

-- Update the check_achievements function to look for 'Questr' instead of 'questsmith'
...
BEGIN
    ...
    LOOP
        ...
        -- --- META ---
        ELSIF r_achievement.code = 'Questr' AND v_achievements_unlocked >= 25 THEN
             PERFORM award_achievement(user_id_input, r_achievement.id);
